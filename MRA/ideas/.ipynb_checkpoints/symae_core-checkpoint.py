...
class DecDense2(tf.keras.Model):
  def __init__(self):
    ...
    self.d2=tfkltd(tfkl.Dense(200))
    self.d3=tfkltd(tfkl.Dense(20))
    self.drop1=tfkl.Dropout(0.5)
    self.d4=tfkltd(tfkl.Dense(200))
    self.d5=tfkltd(tfkl.Dense(20))
    self.drop2=tfkl.Dropout(0.5)
    self.d6=tfkltd(tfkl.Dense(200))
    self.d7=tfkltd(tfkl.Dense(20))
