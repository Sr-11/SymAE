...
nt = 3 # nt is the number of instances in each X_i, i.e. n_tau in the paper (Xi[1]...Xi[nt])
d = 100 # d is the size of image.
m = 7 # m is the size of kernel. Let m be odd.
...
n1 = 4 # The number of states, i.e. n_epsilon in the paper, i.e. object in BD
n2 = 3 # The number of nuisances, i.e. n_epsilon in the paper, i.e. PSF in BD
