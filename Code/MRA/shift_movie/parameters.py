...
N = 6 # N is the Cardinality of the data set X, i.e. n_X in the paper
nt = 50 # nt is the number of instances in each X_i, i.e. n_tau in the paper (Xi[1]...Xi[nt])
d = 100 # d is the dimensions of image.


# Parameters related to SymAE
p = 2 # Dimensions of the coherent latent space
